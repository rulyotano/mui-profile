...
export default function NugetIcon({ height = null, width = null, useOriginalColor = false }) {
  const theme = useTheme();

  const color = useOriginalColor ? "#004880" : theme.palette.text.primary

  const heightValue = height || theme.spacing(3)
  const widthValue = width || theme.spacing(3)
  
  return (
    <svg width={widthValue} height={heightValue} viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <defs>
