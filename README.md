...
- The main data source is two files named `src/gravatar.json` and `src/settings.json`, but also have a very few data hardcoded. For sure this will be improved in the future
